...
<body>
	...
	<div class="page_title"><h4>찜한 프로젝트</h4></div>
	<hr>
	<div class="row">
			<% ArrayList<MyProVO> likelist = (ArrayList<MyProVO>)request.getAttribute("likelist"); 
			for (int i=0 ; i < likelist.size(); i++) { 
			%>
				<div class="col-lg-4 col-md-6 mb-4">
				<div class="card h-100">
					<a href="#"><img class="card-img-top"
						src="./img/<%=likelist.get(i).getImgurl()%>" alt=""></a>
					<div class="card-body">
						<h4 class="card-title">
							<a href="#"><%=likelist.get(i).getProj()%></a>
						</h4>
						<button onclick="location.href='./Member?action=cancellike&seq_PID=<%=likelist.get(i).getSeq_PID()%>'">좋아요 취소</button>
					</div>
				</div>
			</div>	
			<%}%>
