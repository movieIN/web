			...
			<div id="recommend" class="col-lg-12" style="padding-bottom:20px;flex:0 0 90%;max-width:90%;margin-left:20px;">
				...
				<div id="London" class="tabcontent">
					...
					<table>
						...
						<tr><td>장르</td><td><%=movie.getGenre1() + ", " + movie.getGenre2() %></td></tr>
				...
				<div id="Newyork" class="tabcontent">
										<div style="padding-top:10px; padding-bottom:10px;">
					<p style="display:inline;">예상관객수  <b>299,291명</b></p>
					<p>예상 관객수 누적그래프 </p>
					<img src="/register/img/bunjang3.png" alt="킹스맨 예상 누적 관객수" height="150%" width="90%">
					<p>영화 '분장’ 남연우 감독의 ‘연출/영화가치관’ 구름단어 분석</p>
					<img src="/register/img/bunjang1.png" alt="분장 워드클라우드" height="65%" width="65%">
					<p style="font-size:0.7rem;margin-top:5px;margin-left:56%">made by 성령</p>
					<p>영화 ‘분장’을 통해 남연우 감독이 전하고자 한 이야기 구름단어 분석</p>
					<img src="/register/img/bunjang2.png" alt="분장 워드클라우드" height="65%" width="65%">
					<p style="font-size:0.7rem;margin-top:5px;margin-left:56%">made by 성령</p>
				...
				<div id="Busan" class="tabcontent">
					<div style="padding-top:10px; padding-bottom:10px;">
					<h4 style="display:inline;"><%=1234%></h4>
					</div>
				</div>
				
				<div id="Seoul" class="tabcontent">
					<div style="padding-top:10px; padding-bottom:10px;">
						<%ArrayList<FeedbackVO> feedbackList = dao.listFeedback(project.getSeq_PID());%>
					</div>
