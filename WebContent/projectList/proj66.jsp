		...
		<div class="project-page">
			...
			<div id="recommend" class="col-lg-12" style="padding-bottom:20px;flex:0 0 90%;max-width:90%;margin-left:20px;">
				...
				<div id="Newyork" class="tabcontent">
					...
					<p>예상 관객수 누적그래프 </p>
					<img src="/register/img/once3.png" alt="원스 워드 클라우드" height="150%" width="90%">
					<p>영화 ‘원스’ 관람객 후기 구름단어 분석</p>
					<img src="/register/img/once1.png" alt="원스 워드클라우드" height="65%" width="65%">
